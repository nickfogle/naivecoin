...
class HttpServer {
    constructor(node, blockchain, operator, miner) {
        ...
        this.app.get('/operator/wallets/:walletId/addresses/:addressId/heartbeat', (req, res) => {
            let walletId = req.params.walletId;
            let addressId = req.params.addressId;

            try {
                let tx = operator.getHeartbeatTransactionsForWalletAddress(walletId, addressId);
