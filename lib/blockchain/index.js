...
class Blockchain {
    ...
    getTransactionsForAddress(address) {
        ...
        R.forEach(R.pipe(R.prop('transactions'), R.forEach(tx => {
            R.forEach((txInput) => {
                if (address && txInput.address != address) return;
        ...
        return Array.from(txs);
    }
    
    getHeartbeatTransactionsForAddress(address) {
        let txs = this.getTransactionsForAddress(address);
